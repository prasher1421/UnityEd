...
class after_intermediate_degree : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_after_intermediate_degree, container, false)
...
//        view.findViewById<TextView>(R.id.duration).text="Duration: "+after_Intermediate_Model.data[0].streams[2].duration
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            after_intermediate_degree().apply {
