...
class exams_after_intermediate_medical : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_exams_after_intermediate_medical, container, false)
        ...
        try{
//            var i:Int=0
            for(i in 0 until exam_after_Intermediate_Model.data[0].streams[1].entrance_exams.size) {
                entrance_list.add(exam_after_Intermediate_Model.data[0].streams[1].entrance_exams[i])
            }
